...
function validateRelationshipFields(fields: any): any {
...
function formatRelationshipResults(record: any, field: any, prefix: string = ''): any {
    if (field.includes('.')) {
...
export async function handleQueryRecords(conn: any, args: any) {
    ...
    try {
        ...
        const formattedRecords = result.records.map((record: any, index: any) => {
            const recordStr = fields.map((field: any) => {
